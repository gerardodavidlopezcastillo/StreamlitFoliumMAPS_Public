...
st.sidebar.image(image , caption="Nearest Oil App",width = 256)
app_mode = st.sidebar.selectbox("Choose app mode", ["Run App","About Me"])


if app_mode == 'Run App':

    st.title('Nearest Oil Station App')
    ...
    central_location = c2.text_input('Your Location', 'ZONA 12, GUATEMALA')
    ...
    if len(central_location) != 0 :
        ...
        if c3.button('SHOW MAP'):
            ...
            folium.Marker(location=[geo_source[0],geo_source[1]],
                                ...
                                ,popup = "<b>YOUR LOCATION</b>").add_to(m)
    ...
    col1.markdown('* [**LinkedInnn**](https://www.linkedin.com/in/gdlopezcastillo/)')
    col1.markdown('* [**Website**](https://gdlopezcastillo.com/)')
    col1.markdown('* [**GitHub**](https://github.com/gerardodavidlopezcastillo)')
