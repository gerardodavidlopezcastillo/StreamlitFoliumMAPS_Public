...
if app_mode == 'Run App':
    ...
    col1.markdown('* [**Medium**](https://datexland.medium.com/)')
    col1.markdown('* [**LinkedIn**](https://www.linkedin.com/in/alexanderbolano/)')
    col1.markdown('* [**Website**](https://portafolio-ab.herokuapp.com/)')
    col1.markdown('* [**GitHub**](https://github.com/alexbonella)')
